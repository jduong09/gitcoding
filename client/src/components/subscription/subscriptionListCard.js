...
const SubscriptionListCard = ({ details, setEditingSubscription, handleDelete }) => {
  ...
  return (
    <div className="d-flex">
      ...
      <button onClick={() => handleDelete(subscriptionUuid)} type="button" aria-label="Delete"><FontAwesomeIcon icon={faTrash} /></button>
    </div>
  );
};
